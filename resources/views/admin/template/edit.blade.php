...
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '.insert_sub_product', function(e) {
            ...
            var clone = $("#product-select").clone().attr('id','sub-product-select').addClass('sub-product-select').removeClass('product-select');
        ...
        <form method="POST" action="{{route('template.update')}}">
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="input-material form-control" name="template_name" id="template_name" placeholder="Enter Template Name" value="{{$orders[0]->template_name}}"required>
                    <label for="template_name" class="input-label">Template Name</label>
                </div>
                <div class="col-sm-6">
                    <input type="text" class="input-material form-control" id="template_remark" name="template_remark" placeholder="Enter Template Remark" value="{{$orders[0]->template_remark}}" required>
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="text" class="input-material form-control" name="customer_name" id="customer_name" placeholder="Enter Name" value="{{$orders[0]->customer_name}}">
                    <label for="customer_name" class="input-label">Customer Name</label>
                </div>
                <div class="col-sm-6">
                    <input type="text" class="input-material form-control" id="customer_phone" name="customer_phone" placeholder="Enter Phone" value="{{$orders[0]->customer_phone}}">
                    <label for="customer_phone" class="input-label">Customer Phone</label>
                </div>
            </div>
            <div class="form-group">
                <input type="text" class="input-material form-control" id="customer_address" name="customer_address" placeholder="Enter Address" value="{{$orders[0]->customer_address}}">
                ...
                <div id="add_product{{$i==1?$i:''}}" class="add_product">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <label for="product_total_price{{$i==1?$i:''}}" class="input-label">Product Total Price</label>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <label for="product_serial_no{{$i==1?$i:''}}" class="input-label">Product Serial Number</label>
                        </div>
                        ...
                        <div id="add_sub_product{{$y}}">
                            <div class="form-group row">
                                ...
                                <div class="col-3 col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <label for="sub_product_model_no{{$y}}" class="input-label">Sub Product Model Name</label>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-5 col-sm-5 mb-3 mb-sm-0">
                                    ...
                                    <label for="sub_product_total_price{{$y}}" class="input-label">Sub Product Total Price</label>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-2 col-sm-2 mb-3 mb-sm-0">
                                ...
                                <div class="col-5 col-sm-5 mb-3 mb-sm-0">
                                    ...
                                    <label for="sub_product_serial_no{{$y}}" class="input-label">Sub Product Serial Number</label>
                                </div>
                                <div class="col-5 col-sm-5 mb-3 mb-sm-0">
